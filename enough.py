...
while 1:
    ...
    print("""{}
                iii                                     tt    
yy   yy  gggggg      gggggg   aa aa  sss    eee    eee  tt    
yy   yy gg   gg iii gg   gg  aa aaa s     ee   e ee   e tttt  
 yyyyyy ggggggg iii ggggggg aa  aaa  sss  eeeee  eeeee  tt    
     yy      gg iii      gg  aaa aa     s  eeeee  eeeee  tttt 
 yyyyy   ggggg       ggggg           sss                     
 
 
     Merhaba Birilerini rahatsız etmek istiyorsan doğru yere geldin, İyi eğlenceler!

 
 
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), len(servisler_call), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTGREEN_EX + " 1- SMS Gönder\n 2- Çıkış\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " yGigaSeet\n blazepanel\n non")
        sleep(12)
    elif menu == 2:
        system("cls||clear")
